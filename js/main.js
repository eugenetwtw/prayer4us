        ...
        const response = await fetch(`https://api.openai.com/v1/chat/completions`, {
            ...
            body: JSON.stringify({
                ...
                messages: [{ 
                    ...
                    1. 提供合適聖經經文，繁體中文時選用 和合本 的中譯聖經(格式：『經文』書名 章:節)${currentLanguage === 'en' || currentLanguage === 'ja' || currentLanguage === 'ko' ? '只需' + (currentLanguage === 'en' ? '英文' : currentLanguage === 'ja' ? '日文' : '韓文') : '同時提出中英文'}
