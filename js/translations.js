...
const translations = {
    // German
    'de': {
        mealPrayer: 'Gebet vor dem Essen',
        groupPrayer: 'Gebet für die Kleingruppe',
        title: 'Ich bete mit Ihnen',
        backButton: '↩ Zurück zur Emotionsliste',
        loadingEmotions: '⏳ Weitere Emotionen werden gesucht...',
        customEmotionLabel: 'Bitte beschreiben Sie Ihre aktuelle Situation:',
        submitButton: 'Absenden',
        resetButton: 'Emotionen zurücksetzen',
        otherSituation: 'Ich habe eine andere Situation',
        loadingVerse: '⏳ Passende Bibelstelle wird gesucht...',
        ...
        voiceSelector: 'Stimme wählen',
        alloy: 'Alloy (Ausgewogen)',
        echo: 'Echo (Tief)',
        fable: 'Fable (Warm)',
        onyx: 'Onyx (Kräftig)',
        ...
        errorGettingVerse: '❌ Fehler beim Abrufen der Bibelstelle, bitte später erneut versuchen',
        audioPlayError: 'Audio kann nicht abgespielt werden, bitte später erneut versuchen',
        parseError: '⚠️ Antwort konnte nicht analysiert werden, hier der Originalinhalt:',
        apiKeyNotSetAudio: 'API-Schlüssel nicht gesetzt, Audio kann nicht abgespielt werden',
        languageSelector: 'Sprache',
        continuePrayer: 'Weiter mit einem längeren Gebet',
        prayerLabel: 'Gebet'
    },
    // French
    'fr': {
        mealPrayer: 'Prière avant le repas',
        groupPrayer: 'Prière pour le groupe',
        title: 'Je prie avec vous',
        backButton: '↩ Liste des émotions précédentes',
        loadingEmotions: '⏳ Recherche d\'autres émotions...',
        ...
        verseForEmotion: '📖 Pour ceux qui vivent « {emotion} » :',
        scripture: 'Verset :',
        ...
        voiceSelector: 'Voix',
        alloy: 'Alloy (Équilibré)',
        echo: 'Echo (Profond)',
        fable: 'Fable (Chaleureux)',
        onyx: 'Onyx (Puissant)',
        nova: 'Nova (Amical)',
        shimmer: 'Shimmer (Clair)',
        apiKeyNotSet: '❌ Clé API non définie, impossible d\'obtenir le verset',
        errorGettingVerse: '❌ Erreur lors de l\'obtention du verset, veuillez réessayer plus tard',
    ...
    // Italian
    'it': {
        mealPrayer: 'Preghiera prima del pasto',
        groupPrayer: 'Preghiera per il gruppo',
        title: 'Prego con te',
        backButton: '↩ Torna alla lista delle emozioni',
        loadingEmotions: '⏳ Ricerca di altre emozioni in corso...',
        customEmotionLabel: 'Descrivi la tua situazione attuale:',
        submitButton: 'Invia',
        ...
        verseForEmotion: '📖 Per chi sta vivendo "{emotion}":',
        scripture: 'Versetto:',
        ...
        voiceSelector: 'Voce',
        alloy: 'Alloy (Bilanciato)',
        echo: 'Echo (Profondo)',
        fable: 'Fable (Caldo)',
        onyx: 'Onyx (Forte)',
        nova: 'Nova (Amichevole)',
        shimmer: 'Shimmer (Luminoso)',
        apiKeyNotSet: '❌ Chiave API non impostata, impossibile recuperare il versetto',
        errorGettingVerse: '❌ Errore nel recupero del versetto, riprova più tardi',
    ...
    // Dutch
    'nl': {
        mealPrayer: 'Gebed voor de maaltijd',
        groupPrayer: 'Gebed voor de groep',
        title: 'Ik bid met u',
        backButton: '↩ Terug naar emotielijst',
        loadingEmotions: '⏳ Meer emoties worden gezocht...',
        customEmotionLabel: 'Beschrijf uw huidige situatie:',
        submitButton: 'Verzenden',
        resetButton: 'Emotie selectie resetten',
        otherSituation: 'Ik heb een andere situatie',
        loadingVerse: '⏳ Passende bijbeltekst wordt gezocht...',
        verseForEmotion: '📖 Voor degenen die "{emotion}" ervaren:',
        scripture: 'Bijbeltekst:',
        explanation: 'Uitleg:',
        prayer: 'Gebed:',
        playPrayer: '▶ Gebed afspelen',
        generatingAudio: '⏳ Audio wordt gegenereerd...',
        voiceSelector: 'Stem kiezen',
        ...
        apiKeyNotSet: '❌ API-sleutel niet ingesteld, kan bijbeltekst niet ophalen',
        errorGettingVerse: '❌ Fout bij het ophalen van de bijbeltekst, probeer het later opnieuw',
        audioPlayError: 'Kan audio niet afspelen, probeer het later opnieuw',
        parseError: '⚠️ Kan antwoord niet analyseren, hier is de originele inhoud:',
    ...
    // Spanish
    'es': {
        mealPrayer: 'Oración antes de la comida',
        groupPrayer: 'Oración para el grupo',
        title: 'Rezo contigo',
        backButton: '↩ Volver a la lista de emociones',
        loadingEmotions: '⏳ Buscando más emociones...',
        customEmotionLabel: 'Por favor describe tu situación actual:',
        submitButton: 'Enviar',
        resetButton: 'Restablecer selección de emociones',
        otherSituation: 'Tengo otra situación',
        loadingVerse: '⏳ Buscando un versículo apropiado...',
        verseForEmotion: '📖 Para quienes experimentan "{emotion}":',
        scripture: 'Versículo:',
        ...
        apiKeyNotSet: '❌ Clave API no establecida, no se puede obtener el versículo',
        errorGettingVerse: '❌ Error al obtener el versículo, inténtalo de nuevo más tarde',
        audioPlayError: 'No se puede reproducir el audio, inténtalo de nuevo más tarde',
        parseError: '⚠️ No se pudo analizar la respuesta, aquí está el contenido original:',
        apiKeyNotSetAudio: 'Clave API no establecida, no se puede reproducir el audio',
    ...
    // English
    'en': {
        mealPrayer: 'Prayer before meal',
        groupPrayer: 'Prayer for small group fellowship',
